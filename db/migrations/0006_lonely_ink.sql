ALTER TABLE "analytics" ALTER COLUMN "user_id" SET DATA TYPE uuid;--> statement-breakpoint
ALTER TABLE "carts" ALTER COLUMN "user_id" SET DATA TYPE uuid;--> statement-breakpoint
ALTER TABLE "custom_orders" ALTER COLUMN "user_id" SET DATA TYPE uuid;--> statement-breakpoint
ALTER TABLE "newsletter_subscriptions" ALTER COLUMN "user_id" SET DATA TYPE uuid;--> statement-breakpoint
...
ALTER TABLE "cart_items" ADD COLUMN "unit_price" numeric(10, 2);