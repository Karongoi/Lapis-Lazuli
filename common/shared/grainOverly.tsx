const GrainOverlay = () => {
    return (
        <>
            ...
            <div
                className="pointer-events-none absolute inset-0 z-9 opacity-40"
                style={{
            ...
            <div
                className="pointer-events-none absolute inset-0 z-8 opacity-35"
                style={{
            ...
            <div
                className="pointer-events-none absolute inset-0 z-7 opacity-25"
                style={{
